...
class AlphaReg extends TestNgTestBase {
  private boolean acceptNextAlert = true;
  private StringBuffer verificationErrors = new StringBuffer();

  @Test
  public void testAlphaReg() throws Exception {
    ...
    driver.findElement(By.id("tds_body_popupAddPerson_txtFirstName_I")).sendKeys("Gilbert");
    driver.findElement(By.id("tds_body_popupAddPerson_txtLastName_I")).clear();
    driver.findElement(By.id("tds_body_popupAddPerson_txtLastName_I")).sendKeys("Chesterton");
    driver.findElement(By.id("tds_body_popupAddPerson_txtEmail_I")).clear();
    driver.findElement(By.id("tds_body_popupAddPerson_txtEmail_I")).sendKeys("volf1212+2@gmail.com");
    ...
    try {
      assertEquals("Gilbert Chesterton", driver.findElement(By.id("lblName")).getText());
    } catch (Error e) {
